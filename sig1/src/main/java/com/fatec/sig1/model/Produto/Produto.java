...
public class Produto {
    ...
    @OneToMany(mappedBy = "produto", fetch = FetchType.LAZY, cascade = CascadeType.MERGE, orphanRemoval = true)
    ...
    public Produto(String nome, String fabricante, String modelo, float preco,
            String vendedor, String linkProduto, Map<String, String> especificacoes) {
        this.nome = nome;
